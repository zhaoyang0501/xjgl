...
<head>
<script type="text/javascript" src="${pageContext.request.contextPath}/admin/js/ace/admin.apply.js"></script>
...
<body>
					...
					<div class="span12">
						<div class="content-widgets light-gray">
							...
							<div class="box well form-inline">
								...
								<a onclick="$.adminApply.initSearchDataTable()"
	...
	<div class="modal hide fade" id="_modal">
		...
		<div class="modal-footer center" id="div_footer">
			<a class="btn btn-primary" onclick="$.adminApply.saveApply()">保存</a>
